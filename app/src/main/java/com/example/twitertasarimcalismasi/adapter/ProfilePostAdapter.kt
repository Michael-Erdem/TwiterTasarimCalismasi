...
import com.example.twitertasarimcalismasi.ProfileInfoActivity
...
class ProfilePostAdapter (
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        ...
        holder.profilePicture.setOnClickListener {
            var yeniActivitiyIntent = Intent(context,ProfileInfoActivity::class.java)
            context.startActivity(yeniActivitiyIntent)
        }
    }
